...
public class F10 implements RuleI{
	...
	public void act(ArrayList<EventI> matchedEvents, CorrelatorStateI c) throws Exception {
		PompierCorrelatorStateI pompierCorrelatorState = (PompierCorrelatorStateI) c;
		GeneralAlarmFeu alarmGeneral = (GeneralAlarmFeu) matchedEvents.get(0);
		pompierCorrelatorState.declancheGeneralAlarme((AbsolutePosition) alarmGeneral.getCorrelatedEvents().get(0).getPropertyValue("position"));
